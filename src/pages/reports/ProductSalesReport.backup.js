...
import { getProductSalesReport, getProducts } from '../../utils/api';
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (Array.isArray(response)) {
        ...
        // Handle case where response is an object with a data array
        productsData = response.data;
      } else if (response && response.products && Array.isArray(response.products)) {
        // Handle case where products are nested under a products key
        productsData = response.products;
      } else if (response && response.data?.products && Array.isArray(response.data.products)) {
        // Handle case where response is { data: { products: [...] } }
